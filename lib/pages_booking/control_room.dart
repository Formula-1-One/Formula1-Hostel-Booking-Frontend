...
class RoomController extends GetxController{
  ...
  void gaintGerbong(int indexGerbongTerpilih){
  ...
  void selectKursi(int indexKursiTerpilih){
    ...
    if( gerbong[indexGerbong.value][indexKursiTerpilih]["status"] == "available"){
      reset();
      gerbong[indexGerbong.value][indexKursiTerpilih].update('status', (value) => 'selected');
    }
